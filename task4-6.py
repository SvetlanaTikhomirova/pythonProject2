...
class OrgStore:
    ...
    def entering(self):
        ...
        if q == 'Q' or q == 'q':
            ...
            return OrgStore.entering(self)


class Printer(OrgStore):
    def to_print(self):
        return f'to print smth {self.numb} times'


class Scanner(OrgStore):
    def to_scan(self):
        return f'to scan smth {self.numb} times'


class Copier(OrgStore):
    def to_copier(self):
...
print(unit_1.entering())
print(unit_2.entering())
print(unit_3.entering())
